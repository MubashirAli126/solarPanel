...
import img from '../images/crowndark.png';
                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="grid sm:grid-cols-12 gap-5 py-8 md:py-8 border-t border-gray-200 lg:ml-11">
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <div className="box-border border-2 border-blue-950 p-8 bg-inherit text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                        ...
                        <div className="col-span-12 lg:col-span-4 mx-auto">
                            ...
                            <ul className="text-md">
                                <li className="mb-2">
                                    <HashLink to="#" className="text-[#013289] font-bold">021 111 000 348</HashLink>
                                </li>
                                <li className="mb-2">
                                    <HashLink to="#" className="text-[#013289] text-md font-medium mb-6">Plot # 672-673, Building 4, Deh Joreji Taluka,</HashLink>
                                </li>
                                <li className="mb-2">
                                    <HashLink to="#" className="text-[#013289] ">District Malir, Bin Qasim,  Karachi</HashLink>
                                </li>
                            </ul>
                        </div>
