                ...
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    <div className=" text-center">
                        ...
                        <div className='flex justify-center relative top-3'>
                            <Link to="/energy-calculator" className=" w-2/4 bg-transparent border hover:bg-blue-900 hover:border-blue-800 text-white justify-center text-center rounded-lg px-10 py-3 flex items-center group">Energy calculator
